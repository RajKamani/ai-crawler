  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      <View style={[styles.header, { backgroundColor: colors.background, borderBottomColor: colors.border }]}>
        <Text style={[styles.headerTitle, { color: colors.text }]}>GITHUB TRENDING</Text>
        <Text style={[styles.headerSubtitle, { color: colors.primary }]}>ACTIVE AI & LLM REPOSITORIES (LAST 7 DAYS)</Text>
      </View>
            ...
            ListEmptyComponent={
              isLoading ? (
                ...
                <View style={[styles.emptyContainer, { backgroundColor: colors.background }]}>
                  ...
                  <Text style={[styles.emptyText, { color: colors.tabIconDefault }]}>NO REPOSITORIES AVAILABLE.</Text>
                </View>
              )
            }
            ListFooterComponent={
              isLoading && posts.length > 0 ? (
                <View style={[styles.footerLoader, { backgroundColor: colors.background, borderTopColor: colors.border }]}>
                  ...
                  <Text style={[styles.footerLoaderText, { color: colors.primary }]}>LOADING MORE REPOS...</Text>
                </View>
              ) : null
            }
          />
